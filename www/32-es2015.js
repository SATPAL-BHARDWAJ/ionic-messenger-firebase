...
const ItemOptions = class {
    constructor(hostRef) {
         ...
         */
        this.side = 'end';
        this.ionSwipe = Object(_core_5ba38749_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionSwipe", 7);
    }
    /** @internal */
...
const ItemSliding = class {
    constructor(hostRef) {
         ...
         */
        this.disabled = false;
        this.ionDrag = Object(_core_5ba38749_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionDrag", 7);
    }
    disabledChanged() {
        if (this.gesture) {
